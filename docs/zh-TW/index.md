...
!!! note "最後驗證"
    **2026-08-29** 於 Ubuntu 26.04 LTS（kernel `7.0.0-30-generic` / `7.0.0-14` baseline、PipeWire `1.6.2`、MrChromebox `2606.1`）。`i915` 已修復（FIFO 近零、CDCLK 450MHz）、鍵盤背光 `chromeos::kbd_backlight`（max 100）經 GNOME 與 sysfs 實測、EC 守護服務 — 見 [verification.md](verification.md) 的重現步驟。
