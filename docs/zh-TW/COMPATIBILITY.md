...
| **GPU / 顯示** | Intel HD Graphics 515 (GT2, 24EU) [8086:191e] | `i915` | 🟢 **正常 (2026-08-29)** | `i915` 綁定 `card1`，`Mesa HD 515` `direct rendering: Yes`，`3200x1800@60 361.31MHz` CDCLK 450MHz FIFO 0，`i915.enable_psr=0 fbc=0 dc=0`（經 `scripts/fix-graphics.sh`）。 |
