...
- 音訊卡：avs_ssm4567 (喇叭 hw:SSM4567,0)、avs_nau8825 (耳機 hw:NAU8825,0)、avs_dmic (麥克風 hw:DMIC,0)、avs_hdaudio (HDMI hw:2,0-2)
- UCM：透過 `audio/install-audio.sh` 建立 fallbacks
- Mixer：DSP Volume 0 陷阱，請用 `amixer -cSSM4567 cget name='DSP Volume'` 檢查
